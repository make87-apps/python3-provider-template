...
def main():
    m87.initialize()
    endpoint = m87.get_provider(name="EXAMPLE_ENDPOINT", requester_message_type=PlainText,
    ...
    def callback(message: PlainText) -> PlainText:
        ...
        return PlainText(header=m87.header_from_message(Header, message=message, append_entity_path="response"),
                         body=message.body[::-1])
